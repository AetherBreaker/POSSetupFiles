...
1. Configure the backup admin account. (Note: Please do not save the account credentials on any files on the computer. I don't want store employees finding and using these credentials)
...
4. Change windows power and sleep settings so the PC never goes to sleep while plugged in.
5. Move [sft-logo-blackbg.jpg](https://github.com/AetherBreaker/POSSetupFiles/blob/main/sft-logo-blackbg.jpg) file to the current user's pictures directory then set it as the desktop background in "Fit" mode.
6. Make Windows set the time zone automatically
...
9. Turn on the following Windows features:
    - .NET Framework 3.5
...
11. Install [PosForDotNet-1.14.1.msi](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Pre-reqs/PosForDotNet-1.14.1.msi)
12. Install [SSCERuntime_x64-ENU.exe](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Pre-reqs/SSCERuntime_x64-ENU.exe)
13. Install [Epson OPOS ADK](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Device%20Drivers/EPSON_OPOS_ADK_V3.00ER26.exe)
    - This will likely need to be done manually, but attempt to make it work in a script anyway please
14. Install the [Zebra Scanner SDK](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Device%20Drivers/Zebra_Scanner_SDK_(64bit)_v3.05.0005.exe)
...
15. Install [Zebra 123Scan](https://drive.google.com/file/d/12mLVMZkAGPiADoUY7aBnQk-SRWv5jWoX/view?usp=sharing)
    ...
    - Likely won't work from command line due to it's unique installer interface. But please test if the installer accepts command line arguements just incase
16. Install the [HP Pole Display OPOS Drivers](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Device%20Drivers/HP%20Pole%20Display%20OPOS/setup.exe)
...
17. Install the [Touchpoint Fingerprint Driver](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Device%20Drivers/touchpoint%20Fingerprint%20Driver/setup.msi)
...
18. Install the [PAX USB Driver](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Device%20Drivers/PAX%20USBDriver_v2.26_20190508/USBDriver.exe)
...
19. Install the Datacap Drivers:
...
20. Install [NET ePay Director Manager](https://github.com/AetherBreaker/POSSetupFiles/blob/main/Installer%20Files%20Directory/FTX%20Device%20Drivers/NETePay-Director-Manager-Install20200814-W8%20(6).exe):
...
21. Install [Epson TM-T88VI Utility](https://drive.google.com/file/d/11KmFe2KBC-5q2LPrVfuaJMBUzd3E2CGZ/view?usp=sharing)
